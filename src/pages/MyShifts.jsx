        ...
        <PullToRefresh onRefresh={handleRefresh}>
          ...
          { label: 'Hours', value: totalHours.toFixed(0) + 'h', icon: Clock, color: 'var(--clay)' },
                                      ...
                                      <div key={label} className="p-3 rounded-2xl text-center" style={{ backgroundColor: 'var(--warm-white)' }}>
                                                      <div className="text-2xl font-semibold mb-0.5" style={{ color, letterSpacing: '-0.02em' }}>{value}</div>div>
                                                      <div className="text-xs" style={{ color: 'var(--clay)' }}>{label}</div>div>
                                      </div>div>
                                    ))}
                                    </div>div>
                                    ...
                                    <Tabs defaultValue="applications" className="w-full">
                                                <TabsList className="w-full grid grid-cols-3 mb-5 p-1 rounded-xl h-auto" style={{ backgroundColor: 'var(--sand)' }}>
                                                              <TabsTrigger value="applications" className="rounded-lg py-2.5 text-sm font-medium transition-all data-[state=active]:shadow-sm data-[state=active]:bg-white" style={{ color: 'var(--earth)' }}>
                                                                              Applications {applications.length > 0 && <span className="ml-1 text-xs opacity-60">{applications.length}</span>span>}
                                                              ...
                                                              <TabsTrigger value="upcoming" className="rounded-lg py-2.5 text-sm font-medium transition-all data-[state=active]:shadow-sm data-[state=active]:bg-white" style={{ color: 'var(--earth)' }}>
                                                                              Confirmed {upcomingShifts.length > 0 && <span className="ml-1 text-xs opacity-60">{upcomingShifts.length}</span>span>}
                                                              </TabsTrigger>TabsTrigger>
                                                              <TabsTrigger value="completed" className="rounded-lg py-2.5 text-sm font-medium transition-all data-[state=active]:shadow-sm data-[state=active]:bg-white" style={{ color: 'var(--earth)' }}>
                                                                              Completed {completedShifts.length > 0 && <span className="ml-1 text-xs opacity-60">{completedShifts.length}</span>span>}
                                                              </TabsTrigger>TabsTrigger>
                                                </TabsList>TabsList>
                          ...
                          <div className="text-center py-20">
                                            ...
                                            <h3 className="text-lg font-semibold mb-1" style={{ color: 'var(--earth)' }}>No applications yet</h3>h3>
                                            <p className="text-sm" style={{ color: 'var(--clay)' }}>Browse shifts to apply</p>p>
                          </div>div>
                        ) : (
                                                ...
                                                <div key={app.id} className="flex items-center justify-between p-4 rounded-2xl" style={{ backgroundColor: 'var(--warm-white)' }}>
                                                                      <div className="flex items-center gap-3">
                                                                        {app.role_type === 'chef'
                                                                                              ...
                                                                                              <div>
                                                                                                                        <p className="font-medium text-sm" style={{ color: 'var(--earth)' }}>{app.venue_name}</p>p>
                                                                      ...
                                                                      <Badge
                                                                                                className="font-medium text-xs capitalize border-0"
                                                                                                style={{
                          ...
                          <div className="text-center py-20">
                                            ...
                                            <h3 className="text-lg font-semibold mb-1" style={{ color: 'var(--earth)' }}>No confirmed shifts</h3>h3>
                                            <p className="text-sm" style={{ color: 'var(--clay)' }}>Browse shifts to get started</p>p>
                          </div>div>
                        ) : (
                          ...
                          <div className="text-center py-20">
                                            ...
                                            <h3 className="text-lg font-semibold mb-1" style={{ color: 'var(--earth)' }}>No completed shifts</h3>h3>
                                            <p className="text-sm" style={{ color: 'var(--clay)' }}>Completed shifts appear here</p>p>
                          </div>div>
                        ) : (
                          <div className="grid md:grid-cols-2 gap-4">
