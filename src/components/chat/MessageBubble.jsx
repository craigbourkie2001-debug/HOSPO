...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-lg flex items-center justify-center mt-0.5" style={{ backgroundColor: 'var(--sand)' }}>
                    <div className="h-2 w-2 rounded-full" style={{ backgroundColor: 'var(--terracotta)' }} />
                </div>
            )}
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "" : "border-slate-200"
                    )} style={isUser ? { backgroundColor: 'var(--terracotta)' } : { backgroundColor: 'white' }}>
                        {isUser ? (
